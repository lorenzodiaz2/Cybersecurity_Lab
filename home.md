...
- IP Bellatrix Machine &rarr; We execute the command `netdiscover -r 10.0.2.0/24`, that is a tool that can scan and monitor network traffic using ARP requests, we find that the Bellatrix machine is located at the address 10.0.2.14, in fact the MAC address coincides with the one set in the VM
 ...
 ![netdiscover+ifconfig](https://github.com/lorenzodiaz2/Repo_prova/blob/main/img/netdiscover%2Bifconfig.png)
...
![sorgente](https://github.com/lorenzodiaz2/Repo_prova/blob/main/img/pagina%2Bsorgente.png)   
...
![etc-passwd](https://github.com/lorenzodiaz2/Repo_prova/blob/main/img/etc-passwd.png)  
...
![auth-log](https://github.com/lorenzodiaz2/Repo_prova/blob/main/img/auth-log.png)  
...
![log-poisoning](https://github.com/lorenzodiaz2/Repo_prova/blob/main/img/log-poisoning.png)  
...
![priv-esc](https://github.com/lorenzodiaz2/Repo_prova/blob/main/img/priv-esc.png)  
...
![johntheripper](https://github.com/lorenzodiaz2/Repo_prova/blob/main/img/johntheripper.png)
...
![flag](https://github.com/lorenzodiaz2/Repo_prova/blob/main/img/flag.png)
